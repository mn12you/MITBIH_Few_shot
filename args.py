...
def parse_args():
    ...
    parser.add_argument('--transform_model_name', type=str, default="fully-connected", help="Transform net after distance metric")
    parser.add_argument('--encoder_model_name', type=str, default="Sembed", help="Feature encoder")
    ...
    parser.add_argument('--encoder_model_path', type=str, default="./model", help="Model saving dir")
    parser.add_argument('--transform_model_path', type=str, default="./model", help="Model saving dir")
    ...
    parser.add_argument('--best_metric', type=float, default=0.0, help="Best performance of validation set")
