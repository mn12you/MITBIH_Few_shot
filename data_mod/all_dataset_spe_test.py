...
if __name__=="__main__":
    ...
    for folds in range(10):
        ...
        test_data_path=Path(base_path,"test","data",basepath+"_fold"+str(folds)+".npy")
        test_label_path=Path(base_path,"test","label",basepath+"_fold"+str(folds)+".npy")
        val_data_path=Path(base_path,"val","data",basepath+"_fold"+str(folds)+".npy")
        val_label_path=Path(base_path,"val","label",basepath+"_fold"+str(folds)+".npy")
        ...
        val_data_path_save=Path(base_path,"val","data",basepath+"_spe"+"_fold"+str(folds)+".npy")
        val_label_path_save=Path(base_path,"val","label",basepath+"_spe"+"_fold"+str(folds)+".npy")

        test_data_path_save=Path(base_path,"test","data",basepath+"_spe"+"_fold"+str(folds)+".npy")
        test_label_path_save=Path(base_path,"test","label",basepath+"_spe"+"_fold"+str(folds)+".npy")
